...
export default function CreateLeaveRequestPage() {
  ...
  const onSubmit = async (data: LeaveRequestFormData) => {
    ...
    try {
      await approvalsApi.createApproval({
        ...
        entityId: "", // Will be generated by backend
        requestedFor: currentEmployeeId,
        requestData: {
        ...
        priority: "normal",
        approvers: [], // Will be determined by backend based on workflow
      });
      addToast({
        title: "Success",
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <Button variant="ghost" onClick={() => router.push("/dashboard/leave/requests")}>
